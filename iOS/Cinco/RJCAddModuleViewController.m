...
@interface RJCAddModuleViewController () <UINavigationBarDelegate>{
    UIColor *tintColour;
    UIColor *barColour;
}
...
@implementation RJCAddModuleViewController
...
- (IBAction)doneButtonPressed:(UIBarButtonItem *)sender {
    [self.delegate addModule:self.textView.text];
}
